_base_ = [
    '../../_base_/models/vivit/vivit_ucf101_2.py', '../../_base_/default_runtime.py'
]
model=dict(backbone=dict(patch_size=16, num_frames=32, image_size=224),
...
work_dir = './work_dirs/vivit_ucf101_ps16_t16_2.py'
...
Epoch(val) [100][1260]	top1_acc: 0.3025, top5_acc: 0.5398, mean_class_accuracy: 0.3057
"""
